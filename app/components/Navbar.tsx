        ...
        <div className="font-black text-2xl flex items-center gap-5">
          ...
          <div className="hidden sm:block">
            <div className="flex items-center bg-gray-100 rounded-md px-3 py-1 shadow-sm max-w-xs w-full md:w-80">
              ...
              >
                <path strokeLinecap="round" strokeLinejoin="round" d="M11 18a7 7 0 100-14 7 7 0 000 14zm9 2l-3-3" />
              </svg>
              <input
                type="text"
                placeholder="Search"
                ...
                <SheetDescription>
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-5 w-full md:w-auto mt-2 md:mt-0">
                    <ul className="flex flex-col md:flex-row gap-6 pt-8 md:gap-8 text-sm font-semibold">
                      <SheetClose asChild>
                        <Link href="/" className="hover:text-black active:text-black">
                          <li>Home</li>
                        </Link>
                      </SheetClose>
                      <SheetClose asChild>
                        <Link href="/about" className="hover:text-black active:text-black">
                          <li>About</li>
                        </Link>
                      </SheetClose>
                      <SheetClose asChild>
                        <Link href="/contactus" className="hover:text-black active:text-black">
                          <li>Contact</li>
                        </Link>
                      </SheetClose>
                      <SheetClose asChild>
                        <Link href="/blog" className="hover:text-black active:text-black">
                          <li>Blog</li>
                        </Link>
                      </SheetClose>
                    </ul>
                    ...
                    <ul className="flex gap-6 text-xl pt-3">
                      <SheetClose asChild>
                        <Link href="/favorite" className="hover:text-black active:text-black">
                          <li>
                            <FaRegHeart />
                          </li>
                        </Link>
                      ...
                      <SheetClose asChild>
                        <Link href="/addToCart" className="hover:text-black active:text-black">
                          <li>
                            <IoCartOutline />
                          </li>
                        </Link>
